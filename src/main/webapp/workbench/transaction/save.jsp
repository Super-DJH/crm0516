	...
	<script>
		...
		$(function () {
			...
			$("#create-stage").change(function () {
				...
				//拿到value(由于key是动态生成的，所以不能直接json.stage，但是可以json[key])
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" id="tranForm" role="form" style="position: relative; top: -30px;">
				...
				<select class="form-control" id="create-transactionOwner" name="owner" >
				  <option></option>
					<c:forEach items="${uList}" var="u">
						<option ${u.id} ${user.id eq u.id ? "selected" : ""}>${u.name}</option>
					</c:forEach>
				</select>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="14e05fca6a9c4ee08bdf751abb1e0b42" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="ef4ba9dd8694443a92200562467e5368" name="contactsId">
			</div>
		</div>
